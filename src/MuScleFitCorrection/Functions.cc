...
ParSet::ParSet() {}
ParSet::ParSet(const TString& inputName,
...
template <class T>
void scaleFunctionBase<T>::setPar(double* Start,
                                  double* Step,
                                  double* Mini,
                                  double* Maxi,
                                  int* ind,
...
// template <class T> inline scaleFunctionBase<T>::~scaleFunctionBase() { }  // defined even though
// it's pure virtual; should be faster this way.
...
template <class T>
double scaleFunction50<T>::scale(const double& pt,
                                 const double& eta,
                                 const double& phi,
                                 const int chg,
                                 const T& parScale) const
{
    ...
    if (eta < parScale[4]) {
        ...
        freq2 = parScale[22];
        phase2 = parScale[23];
        twist = parScale[3] * (eta - parScale[4]) + parScale[7] * (parScale[4] - parScale[8]) +
                parScale[11] * parScale[8];
        // bwd bin
...
template <class T>
double resolutionFunction45<T>::getGEO(const double& pt, const double& eta, const T& parval)
{
    return parval[0];
}

template <class T>
double resolutionFunction45<T>::getMS(const double& pt, const double& eta, const T& parval)
{
    if (eta < -2.0)
        return (parval[1]);
    if (eta < -1.8)
...
template <class T>
double resolutionFunction45<T>::sigmaPt(const double& pt, const double& eta, const T& parval)
{
...
template <class T>
double resolutionFunction46<T>::sigmaPt(const double& pt, const double& eta, const T& parval)
{
...
template <class T>
double resolutionFunction57<T>::getGEO(const double& pt, const double& eta, const T& parval)
{
    // geometrical term
    double qGEO(0);
    if (eta < parval[0]) {
...
template <class T>
double resolutionFunction57<T>::middleParabola(const double& pt, const double& eta, const T& parval)
{
    return parval[15] + parval[16] * eta * eta;
}

template <class T>
double resolutionFunction57<T>::leftParabola(const double& pt, const double& eta, const T& parval)
{
    return parval[6] + parval[7] * (eta - parval[0]) * (eta - parval[0]);
}

template <class T>
inline double resolutionFunction57<T>::rightParabola(const double& pt,
                                                     const double& eta,
                                                     const T& parval)
{
...
template <class T>
inline double resolutionFunction57<T>::leftLine(const double& pt,
                                                const double& eta,
                                                const T& parval)
{
...
template <class T>
double resolutionFunction57<T>::rightLine(const double& pt, const double& eta, const T& parval)
{
...
template <class T>
inline double resolutionFunction57<T>::getMSC(const double& pt, const double& eta, const T& parval)
{
    // MSC term
    double qMSC(0);
    if (eta < parval[0]) {
...
template <class T>
double resolutionFunction57<T>::sigmaPt(const double& pt, const double& eta, const T& parval)
{
...
scaleFunctionBase<double*>* scaleFunctionService(const int identifier)
{
    switch (identifier) {
        case (50):
            ...
            break;
        default:
            std::cout << "scaleFunctionService error: wrong identifier = " << identifier
                      << std::endl;
            exit(1);
    }
}
...
resolutionFunctionBase<double*>* resolutionFunctionService(const int identifier)
{
    switch (identifier) {
        ...
        case (57):
            ...
            break;
        default:
            std::cout << "resolutionFunctService error: wrong identifier = " << identifier
                      << std::endl;
            exit(1);
    }
}
