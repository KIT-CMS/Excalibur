...
if [[ "$@" == "google" ]]; then
    ...
    --filter=-build/header_guard,-build/include_what_you_use,-legal,-readability/braces,-runtime/int,-runtime/references,-whitespace/braces,-whitespace/indent,-whitespace/newline
    exit 0
fi
