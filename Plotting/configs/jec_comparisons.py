...
def comparison_datamc_Zmm_run2(args=None):
  ...
  d = {
    ...
    #'algorithms': ['ak4PFJetsCHS'],
    'www_title': 'Comparison Data MC for Zmm, run2, miniAOD, CHS',
    'www_text':'Run2: Full data mc comparisons for Zmm AOD CHS samples',
    'www': 'comparison_datamc_Zmm_run2_AOD_CHS' if not Res == False else 'comparison_datamc_Zmm_run2_AOD_CHS_noRes',
  ...
  if miniAOD==True and PUPPI==False:
          d.update({
          'files': ['/portal/ekpbms1/home/cheidecker/Excalibur/work/AN/excalibur_data16_25ns_mm_miniAOD_CHS.root', '/portal/ekpbms1/home/cheidecker/Excalibur/work/AN/excalibur_MC16_25ns_mm_miniAOD_CHS.root'],
          'www': 'comparison_datamc_Zmm_run2_miniAOD_CHS' if not Res == False else 'comparison_datamc_Zmm_run2_miniAOD_CHS_noRes',
          'www_title': 'Comparison Data MC for Zmm, run2, miniAOD, CHS',
          'www_text':'Run2: Full data mc comparisons for Zmm miniAOD CHS samples',
          })
  if miniAOD==True and PUPPI==True:
          d.update({
          'files': ['/portal/ekpbms1/home/cheidecker/Excalibur/work/AN/excalibur_data16_25ns_mm_miniAOD_PUPPI.root', '/portal/ekpbms1/home/cheidecker/Excalibur/work/AN/excalibur_MC16_25ns_mm_miniAOD_PUPPI.root'],
          'www': 'comparison_datamc_Zmm_run2_miniAOD_PUPPI' if not Res == False else 'comparison_datamc_Zmm_run2_miniAOD_PUPPI_noRes',
          'www_title': 'Comparison Data MC for Zmm, run2, miniAOD, PUPPI',    
          'www_text':'Run2: Full data mc comparisons for Zmm miniAOD PUPPI samples',
          })
...
def comparison_datamc_Zee_run2(args=None):
  ...
  d = {
    ...
    'corrections': ['L1L2L3Res', 'L1L2L3'] if not Res==False else ['L1L2L3', 'L1L2L3'],
    #'algorithms': ['ak4PFJetsCHS'],
    'www_title': 'Comparison Data MC for Zee, run2, AOD, PUPPI',
    'www_text':'Run2: Full data mc comparisons for Zee AOD CHS samples',
    'www': 'comparison_datamc_Zee_run2_AOD_CHS' if not Res == False else 'comparison_datamc_Zee_run2_AOD_CHS_noRes',
  ...
  if miniAOD==True and PUPPI==False:
    d.update({
    'files': ['/portal/ekpbms1/home/cheidecker/Excalibur/work/AN/excalibur_data16_25ns_ee_miniAOD_CHS.root', '/portal/ekpbms1/home/cheidecker/Excalibur/work/AN/excalibur_MC16_25ns_ee_miniAOD_CHS.root'],
    'www': 'comparison_datamc_Zee_run2_miniAOD_CHS' if not Res == False else 'comparison_datamc_Zee_run2_miniAOD_CHS_noRes',
    'www_title': 'Comparison Data MC for Zee, run2, miniAOD, CHS',
    'www_text':'Run2: Full data mc comparisons for Zee miniAOD CHS samples',
    })
  if miniAOD==True and PUPPI==True:
    d.update({
    'files': ['/portal/ekpbms1/home/cheidecker/Excalibur/work/AN/excalibur_data16_25ns_ee_miniAOD_PUPPI.root', '/portal/ekpbms1/home/cheidecker/Excalibur/work/AN/excalibur_MC16_25ns_ee_miniAOD_PUPPI.root'],
    'www': 'comparison_datamc_Zee_run2_miniAOD_PUPPI' if not Res == False else 'comparison_datamc_Zee_run2_miniAOD_PUPPI_noRes',
    'www_title': 'Comparison Data MC for Zee, run2, miniAOD, PUPPI',    
    'www_text':'Run2: Full data mc comparisons for Zee miniAOD PUPPI samples',
    })
