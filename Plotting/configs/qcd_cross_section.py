...
def plot_something(args=None):
    plots = []
    d = ({
        'files': ['/portal/ekpbms2/home/tberger/ZJtriple/ZJtriple_2019-06-24_jet1pt20/resolution_985/zpt_mad_yb0_ys0.root'],
        #'files': ['/portal/ekpbms2/home/tberger/ZJtriple/ZJtriple_2019-06-24_jet1pt20/resolution_985/zpt_amc_yb0_ys0.root'],
        'folders': [''],
        'www':'test',
        'x_expressions': ['resolution_30_35'],
        'nicks': ['hist'],
        'analysis_modules': ['FunctionPlot'],
        'functions': ['[0]*ROOT::Math::crystalball_function(-abs(x), [1], [3], [2], 0)','[0]*exp(-x**2/[1]**2/2)',],
        #'functions': ['[0]*ROOT::Math::crystalball_function(-abs(x), [1], [3], [2], 0)'],
        'function_fit': ['hist'],
        'function_parameters': ['43.539223,1.3674205,0.013207260,4.9681730','38.866539,0.015700151'],
        #'function_parameters': ['43.539223,1.3674205,0.013207260,4.9681730'],
        'function_nicknames': ['CrystalBall','Gauss'],
        #'function_nicknames': ['CrystalBall'],
        #'function_ranges': ['-0.1,0.1'],
        #'alphas': [0.5],
        'function_display_result': True,
        'texts_y': [0.95,0.85],
