...
class LabelsDictZJet(labels.LabelsDict):
    def __init__(self, additional_labels=None):
        ...
        self.labels_dict.update({
            ...
            'truezmass': '$\mathit{m}_{Z, True}$ / GeV',
            'truezpt': '$\mathit{p}_{T}^{Z, True}$ / GeV',
            'truezy': '$\mathit{y}^{Z, True}$',
            'truezphi': r'$\mathit{\phi}^{Z, True}$',
            ...
            'jetavept':  r'$ \frac{1}{2}(\mathit{p}_{T}^{Jet1}+\mathit{p}_{T}^{Jet2})$ / GeV',
            'jetyboost': r'$ \frac{1}{2}|y^{Jet1}+y^{Jet2}|$',
            'jetystar':  r'$ \frac{1}{2}|y^{Jet1}-y^{Jet2}|$',
            'jet1btag': 'CSV b-Tag',
            ...
            'truephistareta': '$\mathit{\phi}^{*,True}_{\eta}$',
