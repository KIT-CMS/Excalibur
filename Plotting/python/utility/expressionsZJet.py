...
class ExpressionsDictZJet(ExpressionsDict):
	def __init__(self):
		...
		self.expressions_dict.update({
			...
			'muplusRiso': 'muplusiso/mupluspt',
			'muminusRiso': 'muminusiso/muminuspt',
			...
			'deltaRzjet1' : 'sqrt((abs(abs(zphi-jet1phi)-TMath::Pi())-TMath::Pi())**2+(zy-jet1y)**2)',
			'gendeltaRzjet1' : 'sqrt((abs(abs(genzphi-genjet1phi)-TMath::Pi())-TMath::Pi())**2+(genzy-genjet1y)**2)',
			...
			'deltaphimuminusmuplus' : '(abs(abs(abs(muminusphi-muplusphi)-TMath::Pi())-TMath::Pi()))',
			'deltaRmuminusmuplus' : 'sqrt((abs(abs(muminusphi-muplusphi)-TMath::Pi())-TMath::Pi())**2+(muminuseta-mupluseta)**2)',
			...
			'jet1match': 'sqrt((abs(abs(jet1phi-genjet1phi)-TMath::Pi())-TMath::Pi())**2+(jet1y-genjet1y)**2)',
			'jet2match': 'sqrt((abs(abs(jet2phi-genjet2phi)-TMath::Pi())-TMath::Pi())**2+(jet2y-genjet2y)**2)',
			'deltaRjet1genjet2': 'sqrt((abs(abs(jet1phi-genjet2phi)-TMath::Pi())-TMath::Pi())**2+(jet1y-genjet2y)**2)',
			'deltaRjet1genjet3': 'sqrt((abs(abs(jet1phi-genjet3phi)-TMath::Pi())-TMath::Pi())**2+(jet1y-genjet3y)**2)',
			'deltaRjet2genjet1': 'sqrt((abs(abs(jet2phi-genjet1phi)-TMath::Pi())-TMath::Pi())**2+(jet2y-genjet1y)**2)',
			'jet1resolution': '((jet1pt-genjet1pt)/genjet1pt)',
		})
