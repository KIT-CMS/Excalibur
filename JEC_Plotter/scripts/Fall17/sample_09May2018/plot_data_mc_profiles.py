        ...
        for _channel in ("mm", "ee"):
            ...
            for _corr_level in ("L1L2L3",):
                ...
                _plot_collection = plot_data_mc_profiles(
                    sample_data=SAMPLES['Data_Z{}_F_Fall17_JEC{}'.format(_channel, _jecv_data)],
                    sample_mc=SAMPLES['MC_Z{}_DYJets_Fall17_JEC{}'.format(_channel, _jecv_mc)],
                    selection_cuts=_SELECTION_CUTS,
                    subplot_cuts=RUN_PERIOD_CUT_DICTS[4:5],  # run F only
                    jec_correction_string=_corr_level,
                    quantity_pairs=_QUANTITY_PAIRS,
                    sample_label="09May2018",
