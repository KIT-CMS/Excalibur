...
if __name__ == "__main__":
    for _corr_folder in ["L1L2L3"]:
        for _jecv in ("V10",):
            plot_time_dependence(sample=SAMPLES['Data_Zmm_E_Test18_JEC{}'.format(_jecv)],
                             ...
                             dataset_label="Test18 JEC {}".format(_jecv))

#            plot_time_dependence(sample=SAMPLES['Data_Zee_E_Test18_JEC{}'.format(_jecv)],
#                             corrections_folder=_corr_folder,
#                             quantities=_QUANTITIES,
#                             selection_cuts=_SELECTION_CUTS,
#                             additional_cuts=_ADDITIONAL_CUTS,
