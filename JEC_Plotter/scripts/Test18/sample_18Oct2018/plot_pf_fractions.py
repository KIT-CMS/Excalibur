...
SAMPLES_MC = dict(
    mm=SAMPLES['MC_Zmm_DYNJ_Test18_JECV10'],
)
RUN_PERIODS = ["E",]
...
if __name__ == "__main__":
    for _jecv in ("V10",):
        for _channel in ("mm", ):
            _samples_data = [SAMPLES['Data_Z{}_{}_Test18_JEC{}'.format(_channel, _run_period, _jecv)] for _run_period in RUN_PERIODS]
