...
def _workflow(sample_data, sample_mc):
    _phs = []
    ...
    for _corr_level in ('L1L2L3', 'L1L2L3Res'):
        ...
        _ph = PlotHistograms2D(
            basename="data_mc_07Aug2017_JECV5",
...
if __name__ == "__main__":
    _workflow(sample_data=SAMPLES['Data_Zmm_BCDEFGH_JECV5'],
              sample_mc=SAMPLES['MC_Zmm_DYNJ_Madgraph'])
    _workflow(sample_data=SAMPLES['Data_Zee_BCDEFGH_JECV5'],
