...
def expand(config, cutModes, corrLevels, sfmodes = False, default="default"):
	...
	modes = {
		'nocuts':           ['LeadingJetEta', 'Alpha', 'ZPt', 'BackToBack',     'LeadingJetY', 'LeadingGenJetY', 'GenZPt', 'ValidZ', 'ValidGenZ', 'MinNMuons', 'MaxNMuons', 'MuonPt', 'MuonEta', 'MinNElectrons', 'MaxNElectrons', 'ElectronPt', 'ElectronEta', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons', 'MaxNGenMuons','JetID','LeadingJetPt','ValidJets','ZFilter'],
		...
		'nobacktobackcuts': ['LeadingJetEta', 'Alpha', 'ZPt', 'BackToBack',     'LeadingJetY', 'LeadingGenJetY', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
