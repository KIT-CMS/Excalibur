...
def expand(config, cutModes, corrLevels, default="default"):
    ...
    modes = {
        'nocuts':           ['LeadingJetEta', 'Alpha', 'ZPt', 'BackToBack',     'Phistareta', 'GenPhistareta', 'LeadingJetY', 'LeadingGenJetY', 'LeadingGenJetPt', 'GenZPt', 'ValidZ', 'ValidGenZ', 'MinNMuons', 'MaxNMuons', 'MuonPt', 'MuonEta', 'MinNElectrons', 'MaxNElectrons', 'ElectronPt', 'ElectronEta', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons', 'MaxNGenMuons','JetID','LeadingJetPt','ValidJets','ZFilter'],
        'noalphanoetacuts': ['LeadingJetEta', 'Alpha',                          'Phistareta', 'GenPhistareta', 'LeadingJetY', 'LeadingGenJetY', 'LeadingGenJetPt', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
        'noalphacuts':      [                 'Alpha',                          'Phistareta', 'GenPhistareta', 'LeadingJetY', 'LeadingGenJetY', 'LeadingGenJetPt', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
        'noetacuts':        ['LeadingJetEta',                                   'Phistareta', 'GenPhistareta', 'LeadingJetY', 'LeadingGenJetY', 'LeadingGenJetPt', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
        'basiccuts':        ['LeadingJetEta', 'Alpha', 'ZPt',                   'Phistareta', 'GenPhistareta', 'LeadingJetY', 'LeadingGenJetY', 'LeadingGenJetPt', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
        'nobacktobackcuts': ['LeadingJetEta', 'Alpha', 'ZPt', 'BackToBack',     'Phistareta', 'GenPhistareta', 'LeadingJetY', 'LeadingGenJetY', 'LeadingGenJetPt', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
        'finalcuts':                                                           ['Phistareta', 'GenPhistareta', 'LeadingJetY', 'LeadingGenJetY', 'LeadingGenJetPt', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
        'leptoncuts':     ['MinNGenMuons','GenMuonPt','GenMuonEta','ZPt','GenZPt','ValidZ','ValidGenZ','Phistareta','GenPhistareta','LeadingJetY','LeadingGenJetY','LeadingJetPt','LeadingGenJetPt','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetEta','BackToBack','Alpha'],
        'genleptoncuts' : [   'MinNMuons',   'MuonPt',   'MuonEta','ZPt','GenZPt','ValidZ','ValidGenZ','Phistareta','GenPhistareta','LeadingJetY','LeadingGenJetY','LeadingJetPt','LeadingGenJetPt','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetEta','BackToBack','Alpha'],
        'allleptoncuts' : [                                        'ZPt','GenZPt','ValidZ','ValidGenZ','Phistareta','GenPhistareta','LeadingJetY','LeadingGenJetY','LeadingJetPt','LeadingGenJetPt','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetEta','BackToBack','Alpha'],
        'zcuts':          ['MinNGenMuons','GenMuonPt','GenMuonEta',      'GenZPt',         'ValidGenZ','Phistareta','GenPhistareta','LeadingJetY','LeadingGenJetY','LeadingJetPt','LeadingGenJetPt','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetEta','BackToBack','Alpha'],
        ...
        'allzcuts' :                                                                                  ['Phistareta','GenPhistareta',                                                                'MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetEta','BackToBack','Alpha'],
        'phistaretacuts':   ['MinNGenMuons','GenMuonPt','GenMuonEta','ZPt','GenZPt','ValidZ','ValidGenZ',           'GenPhistareta',              'LeadingGenJetY',               'LeadingGenJetPt','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetEta','BackToBack','Alpha'],
        'genphistaretacuts':[   'MinNMuons',   'MuonPt',   'MuonEta','ZPt','GenZPt','ValidZ','ValidGenZ','Phistareta',              'LeadingJetY',                 'LeadingJetPt',                  'MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetEta','BackToBack','Alpha'],
        'allphistaretacuts':                                        ['ZPt','GenZPt','ValidZ','ValidGenZ',                                                                                           'MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetEta','BackToBack','Alpha'],
    }
