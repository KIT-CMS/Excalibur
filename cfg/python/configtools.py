...
def expand(config, cutModes, corrLevels, sfmodes = False, default="default"):
	...
	modes = {
		...
		'leptoncuts':     ['MinNGenMuons','GenMuonPt','GenMuonEta','ZPt','GenZPt','ValidZ','ValidGenZ','LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'genleptoncuts' : [   'MinNMuons',   'MuonPt',   'MuonEta','ZPt','GenZPt','ValidZ','ValidGenZ','LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'allleptoncuts' : [                                        'ZPt','GenZPt','ValidZ','ValidGenZ','LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'zcuts':          ['MinNGenMuons','GenMuonPt','GenMuonEta',      'GenZPt',         'ValidGenZ','LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'genzcuts' :      [   'MinNMuons',   'MuonPt',   'MuonEta','ZPt',         'ValidZ',            'LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'allzcuts' :                                                                                  ['LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'zjetcuts':       ['MinNGenMuons','GenMuonPt','GenMuonEta',      'GenZPt',         'ValidGenZ',              'LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'genzjetcuts' :   [   'MinNMuons',   'MuonPt',   'MuonEta',   'ZPt',   'ValidZ',               'LeadingJetY',                 'MaxNMuons','MaxNGenMuons','JetID','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'allzjetcuts' :                                                                                                              ['MaxNMuons','MaxNGenMuons','JetID','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
	}
