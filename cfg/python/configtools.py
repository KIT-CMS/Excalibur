...
def expand(config, cutModes, corrLevels, sfmodes = False, default="default"):
	...
	modes = {
		'nocuts': [ 'JetID', 'ValidJets', 'LeadingJetPt', 'LeadingJetEta', 'LeadingJetY', 'LeadingGenJetY', 'BackToBack', 'Alpha', 'ZPt', 'GenZPt', 'ValidZ', 'ValidGenZ', 'MinNMuons', 'MaxNMuons', 'MuonPt', 'MuonEta', 'MinNElectrons', 'MaxNElectrons', 'ElectronPt', 'ElectronEta', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons', 'MaxNGenMuons', 'ZFilter'],
		'noalphanoetacuts': ['LeadingJetEta', 'Alpha',                          'LeadingJetY', 'LeadingGenJetY', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
		'noalphacuts':      ['Alpha',                                           'LeadingJetY', 'LeadingGenJetY', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
		'noetacuts':        ['LeadingJetEta',                                   'LeadingJetY', 'LeadingGenJetY', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
		'basiccuts':        ['LeadingJetEta', 'Alpha','ZPt',                    'LeadingJetY', 'LeadingGenJetY', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
		'nobacktobackcuts':    ['BackToBack', 'LeadingJetEta', 'Alpha','ZPt',   'LeadingJetY', 'LeadingGenJetY', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
		'noetaphicleaning': ['EtaPhiCleaning','LeadingJetEta', 'Alpha','ZPt',   'LeadingJetY', 'LeadingGenJetY', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
		'finalcuts':                                                          [ 'LeadingJetY', 'LeadingGenJetY', 'GenZPt', 'ValidGenZ', 'GenMuonPt', 'GenMuonEta', 'MinNGenMuons','MaxNGenMuons'],
		'leptoncuts':     ['MinNGenMuons','GenMuonPt','GenMuonEta','ZPt','GenZPt','ValidZ','ValidGenZ','LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'genleptoncuts' : [   'MinNMuons',   'MuonPt',   'MuonEta','ZPt','GenZPt','ValidZ','ValidGenZ','LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'allleptoncuts' : [                                        'ZPt','GenZPt','ValidZ','ValidGenZ','LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'zcuts':          ['MinNGenMuons','GenMuonPt','GenMuonEta',      'GenZPt',         'ValidGenZ','LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'genzcuts' :      [   'MinNMuons',   'MuonPt',   'MuonEta','ZPt',         'ValidZ',            'LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'allzcuts' :                                                                                  ['LeadingJetY','LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'zjetcuts':       ['MinNGenMuons','GenMuonPt','GenMuonEta',      'GenZPt',         'ValidGenZ',              'LeadingGenJetY','MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'genzjetcuts' :   [   'MinNMuons',   'MuonPt',   'MuonEta',   'ZPt',   'ValidZ',               'LeadingJetY',                 'MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
		'allzjetcuts' :                                                                                                              ['MaxNMuons','MaxNGenMuons','JetID','ValidJetsFilter','LeadingJetPt','LeadingJetEta','BackToBack','Alpha'],
	}
