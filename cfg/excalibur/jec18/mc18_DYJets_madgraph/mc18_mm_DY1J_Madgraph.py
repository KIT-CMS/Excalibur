...
def config():
    ...
    cfg["InputFiles"].set_input(
        # bmspath1="{}/dsavoiu/Skimming/ZJet_DY1JetsToLL_Fall17-madgraphMLM_realistic_v10-v1/*.root".format(SE_PATH_PREFIXES['srm_gridka_nrg']),
    ...
    cfg['NumberGeneratedEvents'] = 68844984
    cfg['GeneratorWeight'] = 1.0
    # cfg['CrossSection'] = 1012.5*1.23  # from mc16 config
    cfg['CrossSection'] = 877.8 *1.138  # from https://cms-gen-dev.cern.ch/xsdb/?searchQuery=DAS=DY1JetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8
