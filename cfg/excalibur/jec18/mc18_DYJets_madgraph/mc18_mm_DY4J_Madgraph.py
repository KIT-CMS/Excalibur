...
def config():
    ...
    cfg["InputFiles"].set_input(
        bmspath4="{}/dsavoiu/Skimming/ZJet_DY4JetsToLL_Autumn18-madgraphMLM_realistic_v15-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        ekppath4="{}/dsavoiu/Skimming/ZJet_DY4JetsToLL_Autumn18-madgraphMLM_realistic_v15-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        sg0path4="{}/dsavoiu/Skimming/ZJet_DY4JetsToLL_Autumn18-madgraphMLM_realistic_v15-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
    )
