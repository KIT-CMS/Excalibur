...
def config():
    ...
    cfg["InputFiles"].set_input(
        bmspathA="{}/mschnepf/Skimming/ZJet_DoubleMuon_RUN2018B_13TeV-PromptReco-v2/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        ekppathA="{}/mschnepf/Skimming/ZJet_DoubleMuon_RUN2018B_13TeV-PromptReco-v2/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        sg0pathA="{}/mschnepf/Skimming/ZJet_DoubleMuon_RUN2018B_13TeV-PromptReco-v2/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
    )
