...
def config():
    ...
    cfg["InputFiles"].set_input(
        path1="{}/cheideck/Skimming/ZJet_DY1JetsToLL_Autumn18_LHEZpT_250-400_amcnloFXFX-pythia8_upgrade2018_realistic_v15-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
    )
...
# python getGeneratorWeight.py -n NONE /storage/gridka-nrg/cheideck/Skimming/ZJet_DY1JetsToLL_Autumn18_LHEZpT_250-400_amcnloFXFX-pythia8_upgrade2018_realistic_v15-v1/*.root
# ...processing file 0 (nickname: *)
#         weighted entries =  7997.0
#         entries =  12861.0
# ...processing file 100 (nickname: *)
#         weighted entries =  2114013.0
#         entries =  3337645.0
# ...processing file 200 (nickname: *)
#         weighted entries =  4255088.0
#         entries =  6715092.0
#         n_events_generated: 7531281
#         generatorWeight: 0.63369392272
# }
