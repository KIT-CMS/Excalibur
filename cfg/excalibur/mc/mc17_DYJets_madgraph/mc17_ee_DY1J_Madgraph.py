...
def config():
    ...
    cfg["InputFiles"].set_input(
        ekppathB="srm://cmssrm-kit.gridka.de:8443/srm/managerv2?SFN=/pnfs/gridka.de/cms/disk-only/store/user/dsavoiu/Skimming/ZJet_DY1JetsToLL_Fall17-madgraphMLM_realistic_v10-v1/*.root",
        #ekppathB="/storage/gridka-nrg/dsavoiu/Skimming/ZJet_DY1JetsToLL_Fall17-madgraphMLM_realistic_v10-v1/*.root",
    )
    ...
    cfg['PileupWeightFile'] = os.path.join(configtools.getPath() , 'data/pileup/mc/mc17_DYJets_madgraph/PUWeights_294927-306462_17Nov2017_DY1JetsToLL_Fall17-madgraphMLM_realistic_v10-v1.root')
