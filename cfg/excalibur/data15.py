...
def config():
	...
	cfg["InputFiles"] = configtools.setInputFiles(
		ekppath="/storage/a/mfischer/skims/MF_AnyMu_2015_746/recent/DoubleMu_Run2015B_Jul2015_13TeV/*.root",
		nafpath="/pnfs/desy.de/cms/tier2/store/user/mafische/skims/MF_AnyMu_2015_746/2015-07-17/DoubleMu_Run2015B_Jul2015_13TeV/*.root",
	)
