...
def config():
	...
	cfg["InputFiles"].set_input(
		nafpath0="/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/rereco_2016-11-11/Zll_DoMuRun2016E-ReReco-v1/*.root",
		nafpath1="/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/rereco_2016-11-11/Zll_DoMuRun2016F-ReReco-v1/*.root"
	)
