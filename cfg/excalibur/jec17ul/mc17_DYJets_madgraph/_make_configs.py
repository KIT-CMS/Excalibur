...
def config():
    ...
    cfg['PileupWeightFile'] = os.path.join(configtools.getPath() , 'data/pileup/mc_weights/mc17_DYJets_madgraph/PUWeights_{run}_17Nov2017_DY1JetsToLL_Fall17-madgraphMLM_realistic_v10-v1.root')
