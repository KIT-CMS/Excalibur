...
def config():
    ...
    cfg["InputFiles"].set_input(
        path="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/DYJetsToLL_Pt_0To50_amcatnloFXFX-pythia8_RunIISummer16/*.root",
        )
...
##### MC specific properties: #####
    cfg['NumberGeneratedEvents'] = 32734121
    cfg['GeneratorWeight'] = 0.696073586335
    cfg['CrossSection'] = 5512.4400/5381.3*5352.57924
