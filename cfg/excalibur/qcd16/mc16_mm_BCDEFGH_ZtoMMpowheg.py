...
def config():
    ...
    cfg["InputFiles"].set_input(
        path="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZToMuMu_powheg_RunIISummer16-v1/*.root",
        )
...
##### MC specific properties: #####
    cfg['NumberGeneratedEvents'] = 2977600
    cfg['GeneratorWeight'] = 1.0
    cfg['CrossSection'] = 1980
