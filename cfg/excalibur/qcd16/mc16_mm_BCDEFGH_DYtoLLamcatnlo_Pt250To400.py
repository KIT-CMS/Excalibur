...
def config():
    ...
    cfg["InputFiles"].set_input(
        path1="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/DYJetsToLL_Pt_250To400_amcatnloFXFX-pythia8_RunIISummer16_ext5-v1/*.root",
        path2="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/DYJetsToLL_Pt_250To400_amcatnloFXFX-pythia8_RunIISummer16_ext2-v1/*.root",
        path3="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/DYJetsToLL_Pt_250To400_amcatnloFXFX-pythia8_RunIISummer16_ext1-v1/*.root",
        path4="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/DYJetsToLL_Pt_250To400_amcatnloFXFX-pythia8_RunIISummer16-v1/*.root",
        )
...
##### MC specific properties: #####
    cfg['NumberGeneratedEvents'] = 21185045
    cfg['GeneratorWeight'] = 0.367423576396
    cfg['CrossSection'] = 3.3247/2.99*3.228256512
