...
def config():
    ...
    cfg["InputFiles"].set_input(
        ...
        ekppathB1='root://cmsxrootd-kit.gridka.de/pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimming/ZJet_SingleMuon_Run2016B-07Aug17_ver1-v1/*.root',
        ekppathB2='root://cmsxrootd-kit.gridka.de/pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimming/ZJet_SingleMuon_Run2016B-07Aug17_ver2-v1/*.root',
        ekppathC ='root://cmsxrootd-kit.gridka.de/pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimming/ZJet_SingleMuon_Run2016C-07Aug17-v1/*.root',
        ekppathD ='root://cmsxrootd-kit.gridka.de/pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimming/ZJet_SingleMuon_Run2016D-07Aug17-v1/*.root',
    ...
    cfg = configtools.expand(cfg, ['nocuts', 'leptoncuts'], ['None','L1L2L3'])#, True),'L1L2L3Res'
