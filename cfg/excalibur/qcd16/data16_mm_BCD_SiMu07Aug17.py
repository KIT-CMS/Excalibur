...
def config():
    ...
    cfg["InputFiles"].set_input(
        ...
        bmspathB1='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_SingleMuon_Run2016B-07Aug17_ver1-v1/*.root',
        bmspathB2='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_SingleMuon_Run2016B-07Aug17_ver2-v1/*.root',
        bmspathC ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_SingleMuon_Run2016C-07Aug17-v1/*.root',
        bmspathD ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_SingleMuon_Run2016D-07Aug17-v1/*.root',
        nafpathB1='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_SingleMuon_Run2016B-07Aug17_ver1-v1/*.root',
        nafpathB2='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_SingleMuon_Run2016B-07Aug17_ver2-v1/*.root',
        nafpathC ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_SingleMuon_Run2016C-07Aug17-v1/*.root',
        nafpathD ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_SingleMuon_Run2016D-07Aug17-v1/*.root',
