...
def config():
    ...
    cfg["InputFiles"].set_input(
        ...
        ekppathF ='root://cmsxrootd-kit.gridka.de/pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimming/ZJet_SingleMuon_Run2016F-07Aug17-v1/*.root',
        ekppathG ='root://cmsxrootd-kit.gridka.de/pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimming/ZJet_SingleMuon_Run2016G-07Aug17-v1/*.root',
        ekppathH ='root://cmsxrootd-kit.gridka.de/pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimming/ZJet_SingleMuon_Run2016H-07Aug17-v1/*.root',
