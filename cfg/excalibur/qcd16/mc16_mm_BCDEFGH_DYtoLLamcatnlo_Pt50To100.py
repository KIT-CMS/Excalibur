...
def config():
    ...
    cfg["InputFiles"].set_input(
        path1="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/DYJetsToLL_Pt_50To100_amcatnloFXFX-pythia8_RunIISummer16_ext3-v1/*.root",
        path2="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/DYJetsToLL_Pt_50To100_amcatnloFXFX-pythia8_RunIISummer16-v3/*.root",
        )
...
##### MC specific properties: #####
    cfg['NumberGeneratedEvents'] = 130582589
    cfg['GeneratorWeight'] = 0.36444848708
    cfg['CrossSection'] = 374.6800/354.39*363.81428
