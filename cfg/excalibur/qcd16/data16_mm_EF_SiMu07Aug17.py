...
def config():
    ...
    cfg["InputFiles"].set_input(
        ...
        bmspathE ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_SingleMuon_Run2016E-07Aug17-v1/*.root',
        bmspathF ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_SingleMuon_Run2016F-07Aug17-v1/*.root',
        nafpathE ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_SingleMuon_Run2016E-07Aug17-v1/*.root',
