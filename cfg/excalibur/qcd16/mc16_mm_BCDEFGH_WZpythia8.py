...
def config():
    ...
    cfg["InputFiles"].set_input(
        bmspath="root://cmsxrootd-kit.gridka.de//pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimming/ZJet_WZ_TuneCUETP8M1_13TeV-pythia8_RunIISummer16/*.root",
        nafpath="root://cmsxrootd-kit.gridka.de//pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimming/ZJet_WZ_TuneCUETP8M1_13TeV-pythia8_RunIISummer16/*.root",
        )
