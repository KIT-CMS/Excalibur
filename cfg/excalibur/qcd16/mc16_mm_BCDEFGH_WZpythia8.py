...
def config():
    ...
    cfg["InputFiles"].set_input(
        bmspath="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_WZ_TuneCUETP8M1_13TeV-pythia8_RunIISummer16/*.root",
        nafpath="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ZJet_WZ_TuneCUETP8M1_13TeV-pythia8_RunIISummer16/*.root",
        )
