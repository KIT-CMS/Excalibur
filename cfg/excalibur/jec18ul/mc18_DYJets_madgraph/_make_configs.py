...
def config():
    ...
    cfg['PileupWeightFile'] = os.path.join(configtools.getPath() , 'data/pileup/mc_weights/mc17ul_DYJets_madgraph_data_15May18/PUWeights_' + 'BCDEF' + '_15May2018_DYJetsToLL_madgraphMLM.root')
    ...
    cfg['ZJetPUWeightFiles'] = [os.path.join(configtools.getPath() ,'data/pileup/mc_weights/mc17ul_DYJets_madgraph_data_15May18/PUWeights_{{}}_15May2018_DYJetsToLL_madgraphMLM.root'.format(runperiod)) for runperiod in 'BCDEF']
    # cfg['ZJetPUWeightSuffixes'] = ['{{}}'.format(runperiod) for runperiod in {runs}]
    cfg['ZJetPUWeightSuffixes'] = ['{{}}'.format(runperiod) for runperiod in 'BCDEF']
