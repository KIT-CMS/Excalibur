...
def config():
	...
	cfg["InputFiles"].set_input(
		ekppathD="srm://cmssrm-kit.gridka.de:8443/srm/managerv2?SFN=/pnfs/gridka.de/cms/disk-only/store/user/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017D-PromptReco-v1/*.root",
		)
