...
def config():
    ...
    cfg["InputFiles"].set_input(
        pathB="{}/dsavoiu/Skimming/ZJet_DoubleEG_Run2017B-17Nov2017-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        # bmspathB="{}/dsavoiu/Skimming/ZJet_DoubleEG_Run2017B-17Nov2017-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        # ekppathB="{}/dsavoiu/Skimming/ZJet_DoubleEG_Run2017B-17Nov2017-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
    )
