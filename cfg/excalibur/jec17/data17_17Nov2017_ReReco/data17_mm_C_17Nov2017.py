...
def config():
    ...
    cfg["InputFiles"].set_input(
        pathC="{}/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017C-17Nov2017-v1-r2/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        # bmspathC="{}/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017C-17Nov2017-v1-r2/*.root".format(SE_PATH_PREFIXES['srm_gridka_nrg']),
        # ekppathC="{}/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017C-17Nov2017-v1-r2/*.root".format(SE_PATH_PREFIXES['srm_gridka_nrg']),
    )
