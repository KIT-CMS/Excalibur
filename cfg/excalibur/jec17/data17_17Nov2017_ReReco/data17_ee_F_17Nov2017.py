...
def config():
    ...
    cfg["InputFiles"].set_input(
        ekppathF="srm://cmssrm-kit.gridka.de:8443/srm/managerv2?SFN=/pnfs/gridka.de/cms/disk-only/store/user/dsavoiu/Skimming/ZJet_DoubleEG_Run2017F-17Nov2017-v1/*.root",
        #ekppathF="/storage/gridka-nrg/dsavoiu/Skimming/ZJet_DoubleEG_Run2017F-17Nov2017-v1/*.root",
    )
