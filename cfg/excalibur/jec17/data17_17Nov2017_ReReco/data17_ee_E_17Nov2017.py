...
def config():
    ...
    cfg["InputFiles"].set_input(
        pathE="{}/dsavoiu/Skimming/ZJet_DoubleEG_Run2017E-17Nov2017-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        # bmspathE="{}/dsavoiu/Skimming/ZJet_DoubleEG_Run2017E-17Nov2017-v1/*.root".format(SE_PATH_PREFIXES['srm_gridka_nrg']),
        # ekppathE="{}/dsavoiu/Skimming/ZJet_DoubleEG_Run2017E-17Nov2017-v1/*.root".format(SE_PATH_PREFIXES['srm_gridka_nrg']),
    )
