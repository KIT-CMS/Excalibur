...
def config():
    ...
    cfg["InputFiles"].set_input(
        bmspathB="{}/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017B-17Nov2017-v1-r2/*.root".format(SE_PATH_PREFIXES['srm_gridka_nrg']),
        #bmspathB="/storage/gridka-nrg/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017D-17Nov2017-v1-r2/*.root".format(SE_PATH_PREFIXES['srm_gridka_nrg']),
    )
