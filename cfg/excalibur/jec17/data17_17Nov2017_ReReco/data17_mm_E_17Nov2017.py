...
def config():
    ...
    cfg["InputFiles"].set_input(
        bmspathE="{}/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017E-17Nov2017-v1-r2/*.root".format(SE_PATH_PREFIXES['srm_gridka_nrg']),
        #bmspathE="/storage/gridka-nrg/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017E-17Nov2017-v1-r2/*.root".format(SE_PATH_PREFIXES['srm_gridka_nrg']),
    )
