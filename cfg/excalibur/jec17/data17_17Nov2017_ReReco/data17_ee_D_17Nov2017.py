...
def config():
    ...
    cfg["InputFiles"].set_input(
        pathD="{}/dsavoiu/Skimming/ZJet_DoubleEG_Run2017D-17Nov2017-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        # bmspathD="{}/dsavoiu/Skimming/ZJet_DoubleEG_Run2017D-17Nov2017-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        # ekppathD="{}/dsavoiu/Skimming/ZJet_DoubleEG_Run2017D-17Nov2017-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
    )
