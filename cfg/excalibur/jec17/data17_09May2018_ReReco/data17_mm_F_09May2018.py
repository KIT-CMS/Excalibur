...
def config():
    ...
    cfg["InputFiles"].set_input(
        ekppathF="srm://cmssrm-kit.gridka.de:8443/srm/managerv2?SFN=/pnfs/gridka.de/cms/disk-only/store/user/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017F-09May2018-v1/*.root",
        #ekppathF="/storage/gridka-nrg/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017F-09May2018-v1/*.root",
    )
