...
def config():
    ...
    cfg["InputFiles"].set_input(
        bmspathB="{}/dsavoiu/Skimming/ZJet_DY4JetsToLL_Fall17-madgraphMLM_realistic_v10-v1/*.root".format(SE_PATH_PREFIXES['srm_gridka_nrg']),
        #bmspathB="/storage/gridka-nrg/dsavoiu/Skimming/ZJet_DY4JetsToLL_Fall17-madgraphMLM_realistic_v10-v1/*.root".format(SE_PATH_PREFIXES['srm_gridka_nrg']),
    )
