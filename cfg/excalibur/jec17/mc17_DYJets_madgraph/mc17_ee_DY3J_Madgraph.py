...
def config():
    ...
    cfg["InputFiles"].set_input(
        path="{}/cheideck/Skimming/ZJet_DY3JetsToLL_Fall17-madgraphMLM_realistic_v10-v2/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        # bmspath3="{}/dsavoiu/Skimming/ZJet_DY3JetsToLL_Fall17-madgraphMLM_realistic_v10-v2/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        # ekppath3="{}/dsavoiu/Skimming/ZJet_DY3JetsToLL_Fall17-madgraphMLM_realistic_v10-v2/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
    )
