...
def config():
	...
	cfg["InputFiles"].set_input(
		...
		ekppathA2="srm://cmssrm-kit.gridka.de:8443/srm/managerv2?SFN=/pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimmingtest/ZJet_DoubleEG_Run2017A-PromptReco-v2/*.root",
		ekppathA3="srm://cmssrm-kit.gridka.de:8443/srm/managerv2?SFN=/pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimmingtest/ZJet_DoubleEG_Run2017A-PromptReco-v3/*.root",
		)
