...
def config():
	...
	cfg['PileupWeightFile'] = [configtools.getPath() + 'data/pileup/weights_271036-284044_13TeV_23Sep2016ReReco_Zll_DYJetsToLL_M-50_amcatnloFXFX-pythia8_RunIISummer16.root']
