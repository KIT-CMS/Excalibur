...
def config():
	...
	cfg['PileupWeightFile'] = [configtools.getPath() + 'data/pileup/weights_271036-284044_13TeV_23Sep2016ReReco_Zll_DYJetsToLL_M-50_HT-400to600_madgraphMLM-pythia8_RunIISummer16.root']
	cfg['NumberGeneratedEvents'] = 1070454 # for: HT-400to600_madgraphMLM
	cfg['GeneratorWeight'] = 1.0
	cfg['CrossSection'] = 5.678
	return cfg
