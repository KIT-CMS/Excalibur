...
def config():
    ...
    cfg["InputFiles"].set_input(
        #bmspath=_path_prefix + "/store/user/tberger/Skimming/MC-Summer16_metfix/Zll_DY2JetsToLL_M-50_madgraphMLM-pythia8_RunIISummer16/*.root",
        bmspath=_path_prefix + "/store/user/dsavoiu/Skimming/ZJet_DY2JetsToLL_Summer16-madgraphMLM_asymptotic_2016_TrancheIV_v6-v1_egmSSbackport/*.root",
    )
