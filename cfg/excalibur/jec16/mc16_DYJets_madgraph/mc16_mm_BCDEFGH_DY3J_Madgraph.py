...
def config():
    ...
    cfg["InputFiles"].set_input(
        # ekppath="{}/tberger/Skimming/MC-Summer16_metfix/Zll_DY3JetsToLL_M-50_madgraphMLM-pythia8_RunIISummer16/*.root".format(SE_PATH_PREFIXES['srm_desy_dcache']),
        ...
        # nafpath="{}/tberger/Skimming/MC-Summer16_metfix/Zll_DY3JetsToLL_M-50_madgraphMLM-pythia8_RunIISummer16/*.root".format(SE_PATH_PREFIXES['local_desy_dcache']),
