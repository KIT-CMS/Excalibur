...
def config():
	...
	cfg["InputFiles"].set_input(
            #ekppath="srm://dcache-se-cms.desy.de:8443/srm/managerv2?SFN=/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/MC-Summer16_metfix/Zll_DY4JetsToLL_M-50_madgraphMLM-pythia8_RunIISummer16/*.root",
            ekppath=_path_prefix + "/store/user/dsavoiu/Skimming/ZJet_DY4JetsToLL_Summer16-madgraphMLM_asymptotic_2016_TrancheIV_v6-v1/*.root"
