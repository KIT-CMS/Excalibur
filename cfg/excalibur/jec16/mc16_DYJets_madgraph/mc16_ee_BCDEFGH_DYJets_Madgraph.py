...
def config():
    ...
    cfg["InputFiles"].set_input(
        ...
        bmspath="srm://dcache-se-cms.desy.de:8443/srm/managerv2?SFN=/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/MC-Summer16_metfix/Zll_DYJetsToLL_M-50_madgraphMLM-pythia8_RunIISummer16/*.root",
