...
def config():
    ...
    cfg["InputFiles"].set_input(
        pathF="{}/tberger/Skimming_94X/SingleMuon_Run2016F-17Jul2018-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        pathG="{}/tberger/Skimming_94X/SingleMuon_Run2016G-17Jul2018-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        pathH="{}/tberger/Skimming_94X/SingleMuon_Run2016H-17Jul2018-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
    )
