...
def config():
    ...
    cfg["InputFiles"].set_input(
        pathB1="{}/tberger/Skimming_94X/DoubleMuon_Run2016B-17Jul2018_ver1-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        pathB2="{}/tberger/Skimming_94X/DoubleMuon_Run2016B-17Jul2018_ver2-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        pathC= "{}/tberger/Skimming_94X/DoubleMuon_Run2016C-17Jul2018-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        pathD= "{}/tberger/Skimming_94X/DoubleMuon_Run2016D-17Jul2018-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        )
