...
def config():
    ...
    cfg["InputFiles"].set_input(
        ...
        pathB1="{}/tberger/Skimming/ZJet_DoubleMuon_Run2016B-Legacy-07Aug2017_ver1-v1/*.root".format(
            SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        pathB2="{}/tberger/Skimming/ZJet_DoubleMuon_Run2016B-Legacy-07Aug2017_ver2-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        pathC="{}/tberger/Skimming/ZJet_DoubleMuon_Run2016C-Legacy-07Aug2017-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        pathD="{}/tberger//Skimming/ZJet_DoubleMuon_Run2016D-Legacy-07Aug2017-v1/*.root".format(SE_PATH_PREFIXES['xrootd_gridka_nrg']),
        )
