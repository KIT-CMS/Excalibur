...
def config():
    ...
    cfg["InputFiles"].set_input(
        ekppathF="{}/dsavoiu/Skimming/ZJet_DoubleElectron_Run2016F-Legacy-07Aug2017-v1/*.root".format(_path_prefix),
        ekppathG="{}/dsavoiu/Skimming/ZJet_DoubleElectron_Run2016G-Legacy-07Aug2017-v1/*.root".format(_path_prefix),
        ekppathH="{}/dsavoiu/Skimming/ZJet_DoubleElectron_Run2016H-Legacy-07Aug2017-v1/*.root".format(_path_prefix),
        )
