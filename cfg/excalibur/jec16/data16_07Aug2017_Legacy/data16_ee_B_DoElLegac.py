...
def config():
    ...
    cfg["InputFiles"].set_input(
        ekppathB1="{}/tberger/Skimming/ZJet_DoubleElectron_Run2016B-Legacy-07Aug2017_ver1-v1/*.root".format(_path_prefix),
        ekppathB2="{}/tberger/Skimming/ZJet_DoubleElectron_Run2016B-Legacy-07Aug2017_ver2-v2/*.root".format(_path_prefix),
        )
    cfg['Pipelines']['default']['Processors'] += ['filter:EtaPhiCleaningCut']
    cfg['CutEtaPhiCleaningFile'] = os.path.join(configtools.getPath() , 'data/cleaning/hcal-legacy-runB.root') #File used for eta-phi-cleaning, must contain a TH2D called "h2jet"
