...
def config():
    ...
    cfg["InputFiles"].set_input(
        bmspathE="{}/tberger/Skimming/ZJet_DoubleMuon_Run2016E-Legacy-07Aug2017-v1/*.root".format(SE_PATH_PREFIX),
        bmspathF="{}/tberger/Skimming/ZJet_DoubleMuon_Run2016F-Legacy-07Aug2017-v1/*.root".format(SE_PATH_PREFIX),
        ekppathE="{}/tberger/Skimming/ZJet_DoubleMuon_Run2016E-Legacy-07Aug2017-v1/*.root".format(SE_PATH_PREFIX),
