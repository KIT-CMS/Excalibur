...
def config():
	...
	cfg['PileupWeightFile'] = [configtools.getPath() + 'data/pileup/weights_271036-284044_13TeV_23Sep2016ReReco_Zll_DYJetsToLL_M-50_madgraphMLM-pythia8_RunIISummer16.root']
	cfg['NumberGeneratedEvents'] = 49144274 # for: HT-full_madgraphMLM
	cfg['GeneratorWeight'] = 1.0
	#cfg['CrossSection'] = 6025.2 # without genHT cuts
	cfg['CrossSection'] = 6025.2-175.3-147.40-40.99-5.678-1.367-0.6304-0.1514-0.003565
	#cfg['Pipelines']['default']['Processors'] = ['filter:GenHTCut']
	#cfg['CutGenHTMax'] = 70
	return cfg
