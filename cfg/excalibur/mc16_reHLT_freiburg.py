...
#ekppath='/home/afriedel/CMSSW_8_0_22/src/Kappa/Skimming/zjet/skim80_jtb.root',
	...
	cfg = configtools.expand(cfg, ['zcuts',  'leptoncuts', 'genzcuts', 'genleptoncuts', 'allzcuts', 'allleptoncuts'], ['None'])
	configtools.remove_quantities(cfg, ['jet1btag', 'jet1qgtag', 'jet1rc'])
	cfg['NumberGeneratedEvents'] = 104083466 #for:  /DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/RunIIFall15DR76-PU25nsData2015v1_76X_mcRun2_asymptotic_v12_ext4-v1/AODSIM
