...
def config():
    ...
    cfg["InputFiles"].set_input(
        ekppathB="srm://cmssrm-kit.gridka.de:8443/srm/managerv2?SFN=/pnfs/gridka.de/cms/disk-only/store/user/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017B-17Nov2017-v1-r2/*.root",
        #ekppathB="/storage/gridka-nrg/dsavoiu/Skimming/ZJet_DoubleMuon_Run2017D-17Nov2017-v1-r2/*.root",
    )
