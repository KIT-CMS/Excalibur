...
def config():
	...
	cfg["InputFiles"].set_input(
		...
		nafpath4="/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/MC/Zll_DYJetsToLL_M-50_HT-600to800_madgraphMLM-pythia8_RunIISummer16/*.root",
		#nafpath5="/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/MC/Zll_DYJetsToLL_M-50_HT-800to1200_madgraphMLM-pythia8_RunIISummer16/*.root",
		#nafpath6="/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/MC/Zll_DYJetsToLL_M-50_HT-1200to2500_madgraphMLM-pythia8_RunIISummer16/*.root",
		#nafpath7="/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/MC/Zll_DYJetsToLL_M-50_HT-2500toInf_madgraphMLM-pythia8_RunIISummer16/*.root"
	...
	#cfg['PileupWeightFile'] = [configtools.getPath() + 'data/pileup/weights_271036-284044_13TeV_23Sep2016ReReco_Zll_DYJetsToLL_M-50_HT-600to800_madgraphMLM-pythia8_RunIISummer16.root']
	cfg['NumberGeneratedEvents'] = 8292957 # for: HT-600to800_madgraphMLM
	cfg['GeneratorWeight'] = 1.0
	cfg['CrossSection'] = 1.367 
	return cfg
