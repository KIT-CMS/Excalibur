...
def config():
	...
	#cfg['PileupWeightFile'] = [configtools.getPath() + 'data/pileup/weights_271036-284044_13TeV_23Sep2016ReReco_Zll_DYJetsToLL_M-50_HT-70to100_madgraphMLM-pythia8_RunIISummer16.root']
	cfg['NumberGeneratedEvents'] = 9616188 # for: HT-70to100_madgraphMLM
	cfg['GeneratorWeight'] =  1.0
	cfg['CrossSection'] = 175.3
	return cfg
