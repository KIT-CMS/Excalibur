...
def config():
	...
	cfg['PileupWeightFile'] = [configtools.getPath() + 'data/pileup/weights_271036-284044_13TeV_23Sep2016ReReco_Zll_DYJetsToLL_M-50_HT-800to1200_madgraphMLM-pythia8_RunIISummer16.root']
	cfg['NumberGeneratedEvents'] = 2668730 # for: HT-800to1200_madgraphMLM
	cfg['GeneratorWeight'] = 1.0
	cfg['CrossSection'] = 0.6304 
	return cfg
