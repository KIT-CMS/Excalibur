...
def config():
    ...
    cfg["InputFiles"].set_input(
        #ekppath="/storage/c/tberger/testfiles/skimming_output/mc/Zll_DY1JetsToLL_M-50_madgraphMLM-pythia8_RunIISummer16_testfile.root",
    ...
    cfg['PileupWeightFile'] = os.path.join(configtools.getPath() , 'data/pileup/PUWeights_GH_13TeV_23Sep2016ReReco_DYJetsToLL_M-50_amcatnloFXFX-pythia8_RunIISummer16.root')
    cfg['LeptonSFRootfile'] = os.path.join(configtools.getPath(),"data/scalefactors/2016all/SFMC_GH.root")
    cfg['LeptonTriggerSFRootfile'] = os.path.join(configtools.getPath(),"data/scalefactors/2016all/SFTriggerMC_GH.root")
    cfg['TriggerSFRuns'] = []
    return cfg
