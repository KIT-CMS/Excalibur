...
def config():
    ...
    cfg["InputFiles"].set_input(
        ekppath="srm://dcache-se-cms.desy.de:8443/srm/managerv2?SFN=/pnfs/desy.de/cms/tier2/store/user/afriedel/Skimming/mcbkg_Moriond/WJets/*.root",
        nafpath="/pnfs/desy.de/cms/tier2/store/user/afriedel/Skimming/mcbkg_Moriond/WJets/*.root",
        )
    ...
    cfg['NumberGeneratedEvents'] = 57026058
    
    cfg['CrossSection'] = 48770   # ROOT File
    cfg['PileupWeightFile'] = os.path.join(configtools.getPath() , 'data/pileup/PUWeights_'+RUN+'_13TeV_23Sep2016ReReco_WJets.root')
