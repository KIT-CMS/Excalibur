...
def config():
	...
	cfg["InputFiles"].set_input(
		#ekppath='/storage/jbod/tberger/SkimmingResults/Zll_SiMuRun2016D-PromptReco-v2/*.root',
		ekppathE='srm://dcache-se-cms.desy.de:8443/srm/managerv2?SFN=/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/dataminiaod_BC_2016-10-24/Zll_SiMuRun2016E-PromptReco-v2/*.root',
	  	ekppathF='srm://dcache-se-cms.desy.de:8443/srm/managerv2?SFN=/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/dataminiaod_BC_2016-10-24/Zll_SiMuRun2016F-PromptReco-v1/*.root',
		nafpathE='/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/dataminiaod_BC_2016-10-24/Zll_SiMuRun2016E-PromptReco-v2/*.root',
		nafpathF='/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/dataminiaod_BC_2016-10-24/Zll_SiMuRun2016F-PromptReco-v1/*.root',
	)
	...
	cfg['LeptonSFRootfile'] = os.path.join(configtools.getPath(),"data/scalefactors/2016/SFData_BCDEF.root")
	return cfg
