...
def config():
    ...
    cfg["InputFiles"].set_input(
        ...
        ekppath="srm://cmssrm-kit.gridka.de:8443/srm/managerv2?SFN=/pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimming/ZJet_DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_RunIISummer16_noJTB/*.root",
        nafpath="srm://cmssrm-kit.gridka.de:8443/srm/managerv2?SFN=/pnfs/gridka.de/cms/disk-only/store/user/tberger/Skimming/ZJet_DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8_RunIISummer16_noJTB/*.root",
...
##### Specify input sources for Jets & Muons: #####
    ...
    cfg['TaggedJets'] = 'ak4PFJets' # JTB switched off
