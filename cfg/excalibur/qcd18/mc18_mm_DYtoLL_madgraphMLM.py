...
##### MC specific properties: #####
    cfg['NumberGeneratedEvents'] = 49932600 # from dbs
    cfg['GeneratorWeight'] =  0.670123731536 # need to be updated
    cfg['CrossSection'] = 1921.8*3 # need to be updated
#    cfg['PileupWeightFile'] = os.path.join(configtools.getPath() , 'data/pileup/PUWeights_BCDEFGH_13TeV_23Sep2016ReReco_DYJetsToLL_M-50_amcatnloFXFX-pythia8_RunIISummer16.root') # need to be updated
    return cfg
