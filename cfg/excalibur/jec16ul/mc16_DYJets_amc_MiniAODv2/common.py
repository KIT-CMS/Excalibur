...
SE_PATH_PREFIXES = dict(
    ...
    local_gridka_nrg="/storage/gridka",
...
def config(ch, run, jec):
    ...
    if run in "BCDEFearly":
        ...
        IOVS = ['BCD', 'EFearly']
        postfix = 'preVFP_v11'
        inputfiles = "{}/rhofsaess/Skimming/ZJet_DYJetsToLL_Summer20-amcatnloFXFX_mcRun2_asymptotic_preVFP_v11/*.root"
    else:
        APV=False
        runs = 'FlateGH'
        IOVS = ['Flate', 'G', 'H', 'FlateGH']
        postfix = 'v17'
        inputfiles = "{}/rhofsaess/Skimming/ZJet_DYJetsToLL_Summer20-amcatnloFXFX_mcRun2_asymptotic_v17/*.root"
