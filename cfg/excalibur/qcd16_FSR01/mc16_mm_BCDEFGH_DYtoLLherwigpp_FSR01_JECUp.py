...
def config():
    ...
    cfg["InputFiles"].set_input(
        ...
        bmspath="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/DYJetsToLL_madgraphMLM-herwigpp_RunIISummer16/*.root",
        nafpath="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/DYJetsToLL_madgraphMLM-herwigpp_RunIISummer16/*.root",
