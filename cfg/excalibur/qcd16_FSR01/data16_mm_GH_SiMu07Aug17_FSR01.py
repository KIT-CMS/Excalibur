...
def config():
    ...
    cfg["InputFiles"].set_input(
        ...
        bmspathF ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/SingleMuon_Run2016F-07Aug17-v1/*.root',
        bmspathG ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/SingleMuon_Run2016G-07Aug17-v1/*.root',
        bmspathH ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/SingleMuon_Run2016H-07Aug17-v1/*.root',
        nafpathF ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/SingleMuon_Run2016F-07Aug17-v1/*.root',
        nafpathG ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/SingleMuon_Run2016G-07Aug17-v1/*.root',
        nafpathH ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/SingleMuon_Run2016H-07Aug17-v1/*.root',
