...
def config():
    ...
    cfg["InputFiles"].set_input(
        bmspath="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/WWTo2L2Nu_powheg_RunIISummer16/*.root",
        nafpath="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/WWTo2L2Nu_powheg_RunIISummer16/*.root",
        )
...
##### MC specific properties: #####
    cfg['NumberGeneratedEvents'] = 1999000
    cfg['GeneratorWeight'] =  1.0
    cfg['CrossSection'] = 10.48
