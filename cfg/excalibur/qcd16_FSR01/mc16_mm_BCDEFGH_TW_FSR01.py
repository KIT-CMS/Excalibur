...
def config():
    ...
    cfg["InputFiles"].set_input(
        bmspathtW=   "root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ST_tW_top_powheg-pythia8_RunIISummer16/*.root",
        bmspathtbarW="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ST_tW_antitop_powheg-pythia8_RunIISummer16/*.root",
        nafpathtW=   "root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ST_tW_top_powheg-pythia8_RunIISummer16/*.root",
        nafpathtbarW="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/ST_tW_antitop_powheg-pythia8_RunIISummer16/*.root",
        )
...
##### MC specific properties: #####
    cfg['NumberGeneratedEvents'] = 6952830+6933094
    cfg['GeneratorWeight'] = 1.0
    cfg['CrossSection'] = (38.09*6952830+38.06*6933094)/(6952830+6933094)
