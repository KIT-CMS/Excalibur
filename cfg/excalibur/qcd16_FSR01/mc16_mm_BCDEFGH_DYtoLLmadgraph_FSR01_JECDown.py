...
def config():
    ...
    cfg["InputFiles"].set_input(
        ...
        bmspath1="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/DYJetsToLL_madgraphMLM-pythia8_RunIISummer16_v1/*.root",
        bmspath2="root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/DYJetsToLL_madgraphMLM-pythia8_RunIISummer16_v2/*.root",
