...
#cfg['Jec'] = os.path.join(configtools.getPath(), '../JECDatabase/textFiles/Summer16_07Aug2017EF_V11_DATA/Summer16_07Aug2017EF_V11_DATA')
RUN = 'EF'
...
def config():
    ...
    cfg["InputFiles"].set_input(
        ...
        bmspathE ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/SingleMuon_Run2016E-07Aug17-v1/*.root',
        bmspathF ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/SingleMuon_Run2016F-07Aug17-v1/*.root',
        nafpathE ='root://cmsxrootd-redirectors.gridka.de//store/user/tberger/Skimming/SingleMuon_Run2016E-07Aug17-v1/*.root',
