...
def config():
	...
	#cfg['PileupWeightFile'] = [configtools.getPath() + 'data/pileup/weights_271036-284044_13TeV_23Sep2016ReReco_Zll_DYJetsToLL_M-50_HT-1200to2500_madgraphMLM-pythia8_RunIISummer16.root']
	cfg['NumberGeneratedEvents'] = 596079 # for: HT-1200to2500_madgraphMLM
	cfg['GeneratorWeight'] = 1.0
	cfg['CrossSection'] = 0.1514
	return cfg
