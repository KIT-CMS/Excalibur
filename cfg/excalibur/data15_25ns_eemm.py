...
def config():
	...
	cfg["InputFiles"].set_input(
		ekppath="/storage/8/wayand/gc_zjets/full_lep_v4/crab_Zll_DoMuRun2015D-16Dec2015-v1/results//*.root,/storage/8/wayand/gc_zjets/full_lep_v4/crab_Zll_DoElRun2015D-16Dec2015-v2/results/*.root",
