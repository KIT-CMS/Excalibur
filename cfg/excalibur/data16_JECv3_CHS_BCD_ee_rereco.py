...
def config():
	...
	cfg["InputFiles"].set_input(
		...
		nafpath0="/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/rereco_2016-11-11/Zll_DoElRun2016B-ReReco-v2/*.root",
		nafpath1="/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/rereco_2016-11-11/Zll_DoElRun2016B-ReReco-v3/*.root",
		nafpath2="/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/rereco_2016-11-11/Zll_DoElRun2016C-ReReco-v1/*.root",
		nafpath3="/pnfs/desy.de/cms/tier2/store/user/tberger/Skimming/rereco_2016-11-11/Zll_DoElRun2016D-ReReco-v1/*.root"
	)
